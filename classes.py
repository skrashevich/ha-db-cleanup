...
class Device:
    ...
    def __init__(self, **args):
        ...
        self.configuration_url = args['configuration_url'] if args['configuration_url'] else None
...
class DeletedDevice:
    ...
    def __init__(self, **args):
        ...
        self.identifiers = args['identifiers'] if args['identifiers'] else  []
        self.id = args['id'] if args['id'] else None
        self.orphaned_timestamp = args['orphaned_timestamp'] if args['orphaned_timestamp'] else None
...
class Entity:
    ...
    def __init__(self, **args):
        ...
        self.supported_features = args['supported_features'] if ['supported_features'] else None
        self.device_class = args['device_class'] if ['device_class'] else None
        self.unit_of_measurement = args['unit_of_measurement'] if ['unit_of_measurement'] else None
